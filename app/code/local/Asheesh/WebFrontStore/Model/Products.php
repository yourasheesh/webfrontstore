...
class Asheesh_WebFrontStore_Model_Products extends Mage_Core_Model_Abstract
{
	/**
     ...
     * @var string
     */
	protected $_eventPrefix      = 'asheesh_webfrontstore_products';
     ...
     * @var string
     */
    protected $_eventObject      = 'webfrontstore_product';
	...
	protected function _construct()
	{
		 ...
		 */
		$this->_init('webfrontstore_models/products');
	}
